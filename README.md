...
- **Stage 4:** **ACTIVE — FRAMEWORK / GOVERNANCE ONLY.** Latest accepted-reference production main `4f663d0c11339b98fd89639fd8f3d5afc8047fb3`; post-merge Run #282 (`33680628749`) passed Python 3.11/3.12.
- **Stage 4 readiness:** **NOT_READY / 3 remaining prerequisite blockers.** This is not Stage 4 PASS.
- **Real calibration execution:** **BLOCKED / NOT AUTHORIZED.** Accepted reference evidence does not authorize execution.
...
Human reference evidence is accepted, but `calibrationAuthorized=false`, `realDataCalibrationExecutionAuthorized=false`, `realDataCalibrationExecuted=false`, `heldOutTuningUsed=false`; production threshold/resource changes, training and publication remain unauthorized. The next execution step requires a separate exact-scope governance authorization. Stage 5 remains BLOCKED.
