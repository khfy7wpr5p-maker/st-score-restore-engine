#!/usr/bin/env python3
"""Static safety/schema validator for the Stage 11 Stage 9A symbol-region notebook v2."""
...
NOTEBOOK = ROOT / "notebooks/stage11_deepscoresv2_dense_stage9a_symbol_region_eval_v2_colab.ipynb"
...
def main() -> int:
    ...
    for idx,c in enumerate(code_cells):
        ...
        ast.parse(src,filename=f"stage9a-notebook-v2-cell-{idx}")
    print(json.dumps({
        "notebook":"valid",
