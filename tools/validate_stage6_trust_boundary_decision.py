#!/usr/bin/env python3
"""Validate the Stage 6 S6-02 production trust-boundary decision package."""
...
from st_score_restore.stage6_trust_boundary_decision import summarize_stage6_trust_boundary_decision
...
def main() -> int:
    summary = summarize_stage6_trust_boundary_decision(
